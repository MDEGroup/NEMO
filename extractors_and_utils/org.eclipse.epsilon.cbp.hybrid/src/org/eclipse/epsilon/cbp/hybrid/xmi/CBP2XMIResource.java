...
public class CBP2XMIResource extends HybridResource {
    ...
    private void replayEvents(InputStream inputStream, boolean all, File targetDir, int targetLineNumber, String targetSession) throws FactoryConfigurationError, IOException {
	...
	try {
		...
		if (xmlEvent.getEventType() == XMLStreamConstants.END_ELEMENT) {
			...
			if (event instanceof AddToEReferenceEvent || event instanceof AddToResourceEvent) {
