...
public class JuriCBPXMLResourceImpl extends CBPResource {
	...
	public static void main(String[] args) throws Exception {
		...
		CBPResource resource = new JuriCBPXMLResourceImpl();
		...
		resource = new JuriCBPXMLResourceImpl();
	...
	public JuriCBPXMLResourceImpl() {
		super();
	}

	public JuriCBPXMLResourceImpl(URI uri) {
		super(uri);
	}
	...
	public void doSave(OutputStream out, Map<?, ?> options) throws IOException {
		...
		try {
			...
			for (ChangeEvent<?> event : getChangeEvents()) {
	 ...
	 * @throws IOException
	 */
	public EventJuri replayEvents(InputStream inputStream) throws FactoryConfigurationError, IOException {
		...
		try {
			...
			Map<String,EClass> classMap = new HashMap<>();
			List<ChangeEvent> res = new ArrayList<>();
//			int counter = 0;
			while (xmlReader.hasNext()) {
//				counter++;
//				if (counter % 10000 == 0) System.out.println("Computed " + counter);
				event = null;
...
//								EPackage ePackage = EPackage.Registry.INSTANCE.getEPackage(packageName);
							...
							case "add-to-ereference":
								...
								eventino3.setTarget(classMap.get(e.getAttributeByName(new QName("target")).getValue().toString()));
							...
							case "remove-from-ereference":
								...
								eventino4.setTarget(classMap.get(e.getAttributeByName(new QName("target")).getValue().toString()));
								eventino4.setName(e.getAttributeByName(new QName("name")).getValue());
								event = eventino4;
								break;	
							case "set-eattribute":
								SetEAttributeEvent eventino = new SetEAttributeEvent();
								eventino.setTarget(classMap.get(e.getAttributeByName(new QName("target")).getValue().toString()));
							...
							case "set-ereference":
								...
								eventino2.setTarget(classMap.get(e.getAttributeByName(new QName("target")).getValue().toString()));
							...
							case "unset-eattribute":
								...
								eventino5.setTarget(classMap.get(e.getAttributeByName(new QName("target")).getValue().toString()));
							...
							case "unset-ereference":
								...
								eventino6.setTarget(classMap.get(e.getAttributeByName(new QName("target")).getValue().toString()));
							...
							case "add-to-eattribute":
								...
								/// TODO FIXME the current dataset does not include AddToEAttributeEvent operations. 
								/// So, I commented the implementation
								
								AddToEAttributeEvent eventino7 = new AddToEAttributeEvent();
								eventino7.setTarget(classMap.get(e.getAttributeByName(new QName("target")).getValue().toString()));
							...
							case "remove-from-eattribute":
								...
								eventino8.setTarget(classMap.get(e.getAttributeByName(new QName("target")).getValue().toString()));
							...
							case "move-in-eattribute":
								...
								eventino9.setTarget(classMap.get(e.getAttributeByName(new QName("target")).getValue().toString()));
							...
							case "move-in-ereference":
								...
								eventino10.setTarget(classMap.get(e.getAttributeByName(new QName("target")).getValue().toString()));
...
//									EObject eob = classMap.get(seobject);
...
//				}
			...
			return new EventJuri(res, classMap);
		} catch (
	...
	public void generateIgnoreListFile(File cbpFile, File cbpDummyFile, File ignoreListFile) throws IOException {
		...
		options1.put(JuriCBPXMLResourceImpl.OPTION_OPTIMISE_LOAD, false);
		options1.put(JuriCBPXMLResourceImpl.OPTION_KEEP_CHANGE_EVENTS_AFTER_LOAD, false);
		options1.put(JuriCBPXMLResourceImpl.OPTION_GENERATE_MODEL_HISTORY, true);
